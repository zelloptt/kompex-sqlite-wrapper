...
LDLIBSOPTIONS=../lib/debug/KompexSQLiteWrapper_Static_d.a -lpthread -ldl

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../samples/debug/kompex_sqlite_example
...
../samples/debug/kompex_sqlite_example: ${OBJECTFILES}
	...
	g++ -o ../samples/debug/kompex_sqlite_example ${OBJECTFILES} ${LDLIBSOPTIONS} 
